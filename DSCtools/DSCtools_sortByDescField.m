function [DSCdata, sortidx] = DSCtools_sortByDescField(DSCdata, fieldname, transformation)
...
%
%
% Examples:  dsc2 = DSCtools_sortByDescField(dsc,'SAMPLEMASSmg',@(x) str2num(DSCtools_replaceDecimalDelimiter(x,dsc2(1).fileEnc)))
%             
%
