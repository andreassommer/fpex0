function blfun = DSCtools_getBaselinePrimitive(X, Y, index_l, icept_l, slope_l, index_r, icept_r, slope_r, type, res)
% blfun = DSCtools_getBaselinePrimitive(X, Y, index_l, icept_l, slope_l, index_r, icept_r, slope_r, type, res)
%
