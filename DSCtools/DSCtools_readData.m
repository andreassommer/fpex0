function dataMat = DSCtools_readData(fid, enc, columnCount, emptyVal)
   % columnHeaders = DSCtools_readData(fid, enc, columnCount)
   %
   % Imports data from DSCtools export file.
   %
      ...
      while ~feof(fid)
         ...
         if (linelen>0) 
            ...
            if replaceDecimalDelimimiter
               ...
               line = DSCtools_replaceDecimalDelimiter(line, enc);
            end
