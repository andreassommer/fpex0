function [desc, enc, fileHeaderStrings] = DSCtools_readFileHeader(fid, enc)
   ...
   % of a DSCtools file opened in file handle fid.
   %
   % INPUT:   fid --> file id to DSCtools file
   ...
   [~, cutlen] = DSCtools_getNewlineDesc(fid);
   ...
   fileHeaderStrings = DSCtools_replaceChars(fileHeaderStrings, enc);
